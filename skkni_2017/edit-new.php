...
$query = "SELECT * FROM user WHERE ktp = '$_GET[id]'";
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li><a href="new-input-data.php"><i class="fa fa-caret-right"></i> Input Data SKKKNI</a></li>                         
                                                </ul>
                                                <!--
                                                <ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                    ...
                                    <form method="POST" class="form-horizontal" name="form2" role="form" id="form2" action="edit-new-proses.php" data-parsley-validate>
                                    
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">KTP/KTM</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="ktp"  class="form-control" placeholder="KTP"
                                                       data-parsley-trigger="change" data-parsley-type="digits" value="<?php echo $data['ktp'] ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="nama" class="form-control" placeholder="Nama Lengkap" 
                                                       data-parsley-trigger="change" value="<?php echo $data['nama']; ?>"
                                                       required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="tptlahir" class="form-control" placeholder="Tempat Lahir"
                                                       data-parsley-trigger="change" value="<?php echo $data['tptlahir']; ?>"
                                                       required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" name="tgllahir" class="form-control" placeholder="Tanggal Lahir"
                                                       data-parsley-trigger="change" value="<?php echo $data['tgllahir']; ?>"
                                                       required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select type="text" name="jk" class="form-control" placeholder="Jenis Kelamin"
                                                       data-parsley-trigger="change" value="<?php echo $data['jk']; ?>"
                                                       required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="rt" class="form-control" placeholder="RT"
                                                       data-parsley-trigger="change" value="<?php echo $data['rt']; ?>"
                                                       required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="rw" class="form-control" placeholder="RW"
                                                       data-parsley-trigger="change" value="<?php echo $data['rw']; ?>"
                                                       required>
                                            </div>
                                        </div>
...
-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="nohp" class="form-control" placeholder="No HP"
                                                       data-parsley-trigger="change" value="<?php echo $data['nohp']; ?>"
                                                       required>
                                            </div>
                                        </div>
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="alamat" class="form-control" placeholder="Status"
                                                       data-parsley-trigger="change" value="<?php echo $data['alamat']; ?>"
                                                       required>
                                            </div>
                                        </div>
