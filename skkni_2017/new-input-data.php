...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <head>
        ...
        <title>SI SSKNI ROHUL 2017</title>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="new-input-data.php">Input Data SKKNI</a>
                                </li>
                            </ul>
...
<!--
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                            <select type="text" name="jk" class="form-control" placeholder="Jenis Kelamin" required>
